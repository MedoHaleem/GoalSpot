defmodule GoalspotWeb.TaskControllerTest do
  use GoalspotWeb.ConnCase

  alias Goalspot.Goal

  @create_attrs %{description: "some description", done: true, name: "some name", reminder_at: ~D[2010-04-17]}
  ...
  def fixture(:task) do
    {:ok, task} = Goal.create_task(@create_attrs)
    task
  end
